...
class SketchCanvas extends React.Component {
    ...
    _getApproximation() {
        UIManager.dispatchViewManagerCommand(
            this._handle,
            UIManager.RNSketchCanvas.Commands.pathApproximation,
            []
        );
    }
    ...
    loadPanResponder() {
        this.panResponder = PanResponder.create({
            ...
            onPanResponderGrant: (evt, gestureState) => {
                this.didTouchPath(evt, gestureState);
        ...
        return (
            <RNSketchCanvas
                ...
                onChange={(e) => {
                    ...
                    } else if (e.nativeEvent.hasOwnProperty('pathApproximation')) {
                        const apprx = e.nativeEvent.pathApproximation;
                        this._paths.forEach((data) => {
                            data.path.apprx = apprx[data.path.id];
                        });
                    }
                }}
